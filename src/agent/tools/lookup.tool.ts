      ...
      return JSON.stringify({
        ...
        error:
          error instanceof Error
            ? error.message
            : 'Unknown error occurred during lookup',
      })
    }
  },
  {
    name: 'LookupNotes',
    description:
      "Search for similar notes based on a query string. Use this tool to find relevant information from the user's notes to help answer their questions. The results should be used as context to formulate your response.",
    schema: z.object({
