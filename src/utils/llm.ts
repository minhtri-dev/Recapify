...
- IMPORTANT: Randomly distribute correct answers across all options (don't always make A correct)
- The correct answer should be in different positions (sometimes A, sometimes B, C, or D)
...
- Ensure the correctAnswer field contains the exact text of the correct option
...
- VARY which option (A, B, C, or D) is correct - avoid patterns`
...
- Provide 4 distinct options (A, B, C, D)
- VARY the correct answer position - don't always make the first option correct
- Mix up which option (A, B, C, or D) is correct across different questions
...
5. Format as valid JSON as specified`
  ...
  try {
    ...
    // Debug: Log each question's correct answer and options
